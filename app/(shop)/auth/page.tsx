        ...
        <div className="bg-white rounded-4xl shadow-card-hover p-8">
          {success ? (
            ...
            <>
              ...
              {/* Google OAuth */}
              <button className="w-full flex items-center justify-center gap-3 py-3 rounded-2xl border-2 border-brand-beige hover:border-brand-pink hover:bg-brand-pink-light transition-all duration-200 mb-4">
